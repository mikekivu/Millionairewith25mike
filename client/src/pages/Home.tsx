...
export default function Home() {
  return (
    <>
      <Helmet>
        <title>ProsperityGroups - Investment & Genealogy Platform</title>
        <meta name="description" content="Join our exclusive investment platform with multi-level referral rewards. Start your journey to financial freedom today with ProsperityGroups." />
