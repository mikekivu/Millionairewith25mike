...
export default function AdminMessages() {
  ...
  const markAsRespondedMutation = useMutation({
    mutationFn: (messageId: number) => {
      return apiRequest('PUT', `/api/admin/contact-messages/${messageId}/mark-responded`, {});
    },
    onSuccess: () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Messages - MillionaireWith$25 Admin</title>
        <meta name="description" content="Manage and respond to contact messages from users and website visitors." />
      </Helmet>
        ...
        <div className="flex-1 bg-gray-50 p-4 md:p-8 overflow-auto">
          <div className="max-w-7xl mx-auto">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h1 className="text-2xl md:text-3xl font-bold tracking-tight">Contact Messages</h1>
