...
import { UserCog, Key, Shield, LogOut } from 'lucide-react';
...
export default function AdminSettings() {
  ...
  return (
    <>
      <Helmet>
        <title>Admin Settings - ProsperityGroups</title>
        <meta name="description" content="Manage your admin account settings and preferences." />
      </Helmet>
                      ...
                      <form onSubmit={profileForm.handleSubmit(onSubmitProfile)} className="space-y-6">
                        <div className="flex items-center space-x-4">
                          <Avatar className="h-20 w-20">
                            <AvatarImage src={user?.profileImage} alt={user ? `${user.firstName} ${user.lastName}` : 'Admin'} />
                            <AvatarFallback className="text-lg bg-red-100 text-red-800">{getInitials(user)}</AvatarFallback>
                          </Avatar>
                          <div>
                            <h3 className="text-lg font-medium">{user?.firstName} {user?.lastName}</h3>
                            <p className="text-sm text-muted-foreground">{user?.email}</p>
                            <p className="text-xs bg-red-500 text-white px-2 py-0.5 rounded-full inline-flex items-center font-semibold mt-1">
              ...
              <TabsContent value="security">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Change your password to secure your admin account
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Form {...passwordForm}>
              ...
              <TabsContent value="account">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Review your admin account information and actions
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-base capitalize text-red-600 font-semibold">
                  ...
                  <CardFooter className="border-t flex flex-col items-start">
                    <p className="text-sm text-muted-foreground mt-4">
                      As an administrator, you have full access to manage the platform. If you need any technical assistance, please contact the development team.
                    </p>
                  </CardFooter>
                </Card>
              </TabsContent>
