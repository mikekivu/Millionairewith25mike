...
import { ChevronLeft, ChevronRight, MoreHorizontal, SortAsc, SortDesc } from "lucide-react";
                            ...
                            {header.column.getCanSort() && (
                              <span>
                                {header.column.getIsSorted() === "asc" ? (
                                  ...
                                  <MoreHorizontal size={16} className="text-gray-400 opacity-0 group-hover:opacity-100" />
                                )}
                              </span>
                            )}
                          </div>
