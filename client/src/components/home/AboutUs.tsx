        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-lg text-dark-500">
              RichLance is a leading investment platform combining traditional investment strategies with innovative genealogy-based referral systems. Our mission is to empower individuals to achieve financial freedom through smart investing and network building.
            </p>
