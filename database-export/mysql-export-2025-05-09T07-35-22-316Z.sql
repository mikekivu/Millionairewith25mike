-- MySQL compatible export generated on 2025-05-09T07:35:22.318Z
...
CREATE TABLE `investments` (
  ...
  `profit` DECIMAL(18,8) NOT NULL DEFAULT '0'::numeric,
  PRIMARY KEY (`id`)
);
...
CREATE TABLE `payment_settings` (
  ...
  `api_key` TEXT,
  `secret_key` TEXT,
  `method` TEXT NOT NULL DEFAULT 'paypal'::text,
  `name` TEXT NOT NULL DEFAULT 'Payment Method'::text,
  `instructions` TEXT,
  `credentials` TEXT,
  `min_amount` TEXT NOT NULL DEFAULT '10'::text,
  `max_amount` TEXT NOT NULL DEFAULT '10000'::text,
  PRIMARY KEY (`id`)
);
...
CREATE TABLE `referrals` (
  ...
  `commission_amount` DECIMAL(18,8) NOT NULL DEFAULT '0'::numeric,
  `status` TEXT NOT NULL DEFAULT 'active'::text,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
);
...
CREATE TABLE `users` (
  ...
  `first_name` TEXT NOT NULL,
  `last_name` TEXT NOT NULL,
  `wallet_balance` DECIMAL(18,8) NOT NULL DEFAULT '0'::numeric,
  `active` TINYINT(1) NOT NULL DEFAULT 1,
